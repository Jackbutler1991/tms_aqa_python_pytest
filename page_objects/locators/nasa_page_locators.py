...
class ContainerLocators():
    ...
    HEAD_MIS_DROP_OPEN = get_locator_by_id('"nasa-main-menu"]/li[2]')

    HEAD_GALLERIES = get_locator_by_id('"nasa-main-menu"]/li[3]//span[1]')
    HEAD_GAL_DROP_OPEN = get_locator_by_id('"nasa-main-menu"]/li[3]')
    ...
    FOLLOW_NASA_CATEGORIES = get_locator_by_id('"nasa-main-menu"]/'
                                               'li[5]//span[1]')
    FOLLOW_NASA_SPOT_STATION = get_locator_by_id('"nasa-main-menu"]'
                                                 '/li[5]//li[7]/a')
    ...
    NASA_TV_SCHEDULE = get_locator_by_id('"cards"]//div[6]/a[1]')
